# Assignment: Week8,9 Housing Data
...
# In the Housing data , the attributes "sale_warning, ctyname" there are null values at some places.
...
coeff_lmbeta <- lm.beta(housingdata_lm2)
coeff_lmbeta

# zip5 (standardized ?? = 0.03485771) - This value indicates that as zip code increase by 1 standard deviation, 
# the sales price increase by 0.03485771 standard deviation.
# bedrooms (standardized ?? = 0.17877693) -This value indicates that as bedrooms increase by 1 standard deviation, 
# the sales price of the house increase by 0.17877693 standard deviation.
# bath_full_count (standardized ?? =  0.15058250) -This value indicates that as full bath room  increase by 1 standard deviation, 
# the sales price of the house increase by  0.15058250 standard deviation.
# year_built(standardized ?? = 0.16877309 ) - This value indicates that as year_# built increase by 1 standard deviation, 
...
# to the fit of the model to the data compared to housingdata_lm1
