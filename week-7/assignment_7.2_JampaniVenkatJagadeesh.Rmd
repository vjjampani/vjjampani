...
Positive covariance indicates the linear relationship and negative covarance indicates the non linear relation between the variables.
...
3. "TimeReading" and "Happiness" have a weak relation with negative covariance and opposite to each other (-10.35).
4. "TimeReading" and "Gender" have a weak relation with negative covariance and opposite to each other (-0.0818).
5. "TimeTV" and "Gender" have a strong relation with positive covariance and more close to each other (0.0454).
6. "Happiness" and "Gender" have a strong relation with positive covariance and more close to each other (1.116).
...
Happiness : The units of measurement is not properly defined for Happiness variable.

A better alternative is to make the units consistent as either hours/minutes for TimeTV and TimeReading, 
Gender to be a categorical variable with values of either Male/Female corresponding to 1/0 and Happiness possibly represented in percentage out of 100 %.
...
I would choose simple correlation tests between two variables - TimeTV vs. Happiness, TimeReading vs. TimeTV, TimeReading vs.Happiness, TimeReading vs. Gender, TimeTV vs. Gender, Happiness vs. Gender.
Since these variables have a sort of relation with each other.
...
cor.test(studentsurvey_df$TimeReading, studentsurvey_df$Gender)
cor.test(studentsurvey_df$TimeTV, studentsurvey_df$Happiness)
cor.test(studentsurvey_df$TimeTV, studentsurvey_df$Gender)
cor.test(studentsurvey_df$Happiness, studentsurvey_df$Gender)
```
