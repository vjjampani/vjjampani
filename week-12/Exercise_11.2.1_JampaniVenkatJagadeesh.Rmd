...
# Check structure of binary_df
str(binary_df)
# Check sample rows of binary_df
head(binary_df)

# Load the trinary classifier data set to dataframe
trinary_df <- read.csv("data/trinary-classifier-data.csv")

# Check structure of trinary_df
str(trinary_df)
...
# Looking at the plots, I think that the linear classifier would work well on binary data set but not on trinary
# data set
