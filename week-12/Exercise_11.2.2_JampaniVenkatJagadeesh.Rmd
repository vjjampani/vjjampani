---
title: "DSC520 Week10 Exercise 11.2.1"
...
# Load Clustering Data Dataset 
cluster_df <- read.csv("data/clustering-data.csv")

# Check structure of clustering_data_df
str(cluster_df)

# Check sample rows of clustering_data_df
head(cluster_df)


# i.Plot the data set using a scatter plot.
library(ggplot2)
ggplot(data=cluster_df,aes(x=x,y=y)) + geom_point(size=0.4) + ggtitle("Scatter-plot of clustering data")

# ii.Fit the data set using the k-means algorithm from k=2 to k=12. Create a scatter plot of the resultant  clusters for each value of k.
set.seed(123)
